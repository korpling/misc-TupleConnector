...
public interface TupleWriter 
{
	 ...
	 * @param attNames - names of attributes to which data belong
	 */
	...
	/**
	 * Set the distinct value for this tuple writer. If distinct= true, no duplicates will be stored for the same transaction.
	 * duplicates means two or more tuples with the same entries.
	 * To compare two tuples, the equals method of the string
	 * value is used (case sensitive). Default value is false.
	 * Attetntion: setting distinct to true makes add(...) very expensive
	 * @param distinct true if values shall be stored distinct.
	 */
	public void setDistinct(Boolean distinct);
	
	/**
	 * Returns true if this tuple writer stores values more than one times, if they are equal
	 ...
	 * @param tuple - the tuple which shall be stored 
	 */
	 ...
	 * @param TAId - transactional id which is returned by beginTA() 
	 */
	...
	/**
	 * Adds a tuple to the stream without TA-Control.
	 * @param TAId - transactional id to which this adding belongs (returned by beginTA())
	 * @param tuple - the tuple which shall be stored 
	 */

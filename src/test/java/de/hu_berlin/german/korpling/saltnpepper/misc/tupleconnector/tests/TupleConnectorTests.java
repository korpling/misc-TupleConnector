...
public class TupleConnectorTests extends TestCase 
{
	...
	/**
	 * @param tWriter the tWriter to set
	 */
	...
	/**
	 * @param tReader the tReader to set
	 */
	...
	public void testWriteRead() throws Exception
	{
		...
		try
		{
			...
			//schreiben
			String allTuples= 	"attVal11;attVal12;attVal12#"+
								"attVal21;attVal22;attVal22#"+
								"attVal31;attVal32;attVal32";
	...
	public void testTAMgmt() throws Exception
	{
		...
		try
		{
		    ...
		    while (m.find()) 
		    {
		    	...
		    	if (match.endsWith("+")) commit= true;
		    	else if (match.endsWith("-")) commit= false;
		    	match= match.replace("(", "");
		    	match= match.replace(")", "");
		    	match= match.replace("+", "");
		    	match= match.replace("-", "");
				...
				for (String strTuple: strTuples)
				{
					...
					if (commit) commitTuples.add(attCol);
				}
		    	
		    	if (commit) commitList.add(taId);
		    	else tWriter.abortTA(taId);
		    }
